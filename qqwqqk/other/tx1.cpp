...
int sub(vector<int> &list, int x, int y){
  ...
  int sub_1 = x_index < y_index ? x_index - 0 : y_index - 0;
  int sub_2 = x_index < y_index ? y_index - x_index -1 : x_index - y_index - 1;
  int sub_3 = x_index < y_index ? n - y_index - 1: n - x_index - 1;
